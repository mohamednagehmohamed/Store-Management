    ...
    public partial class store6 : Form
    {
       ...
       // SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-EOHECS5\S2008;Initial Catalog=nozomdb;Integrated Security=True");
        ...
        void getalldata()
        {
            ...
            {
                con.Open();
                string query = "select * from store6 order by date desc";
        ...
        void newgetall()
        {
            ...
            {
                con.Open();
                string queryhrary = "select sum(hrary) from store6";
                string querycitizen = "select sum(citizen) from store6";
        ...
        void checkifdatefound()
        {
            ...
            {
                con.Open();
                string query = "select count(*) from store6 where date='" + dateTimePicker1.Value.Date + "'";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "insert into store6 values('" + int.Parse(txthrary.Text) + "','" + int.Parse(txtcitizen.Text) + "','" + dateTimePicker1.Value.Date + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "update store6 set hrary='" + int.Parse(txthrary.Text) + "',citizen='" + int.Parse(txtcitizen.Text) + "',date='" + dateTimePicker1.Value.Date + "'where date='" + dateTimePicker1.Value.Date + "'";
                    SqlCommand cmd = new SqlCommand(query, con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "delete from store6 where date='" + dateTimePicker1.Value.Date + "'";
                    SqlCommand cmd = new SqlCommand(query, con);
