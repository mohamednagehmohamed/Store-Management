...
{
    public partial class store14 : Form
    {
       ...
       // SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-EOHECS5\S2008;Initial Catalog=nozomdb;Integrated Security=True");
        ...
        void getalldata()
        {
            ...
            {
                con.Open();
                string query = "select * from store14 order by date desc";
        ...
        void newgetall()
        {
            ...
            {
                con.Open();
                string querypos = "select sum(pos) from store14";
                string querydevice = "select sum(device) from store14";
                SqlDataAdapter sda = new SqlDataAdapter(querypos, con);
                SqlDataAdapter sda2 = new SqlDataAdapter(querydevice, con);
                DataTable dt1 = new DataTable();
                DataTable dt2 = new DataTable();
                sda.Fill(dt1);
                sda2.Fill(dt2);
                lblpos.Text = dt1.Rows[0][0].ToString();
                lbldevice.Text = dt2.Rows[0][0].ToString();
                con.Close();
            }
            catch (Exception ex)
            {
        ...
        void checkifdatefound()
        {
            ...
            {
                con.Open();
                string query = "select count(*) from store14 where date='" + dateTimePicker1.Value.Date + "'";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (txtpos.Text.Trim() == "" || txtdevice.Text.Trim() == "")
            {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "insert into store14 values('" + int.Parse(txtpos.Text) + "','" + int.Parse(txtdevice.Text) + "','" + dateTimePicker1.Value.Date + "')";
        ...
        private void store14_Load(object sender, EventArgs e)
        {
            getalldata();
            // getallhrary();
            newgetall();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "update store14 set pos='" + int.Parse(txtpos.Text) + "',device='" + int.Parse(txtdevice.Text) + "',date='" + dateTimePicker1.Value.Date + "'where date='" + dateTimePicker1.Value.Date + "'";
                    SqlCommand cmd = new SqlCommand(query, con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "delete from store14 where date='" + dateTimePicker1.Value.Date + "'";
                    SqlCommand cmd = new SqlCommand(query, con);
